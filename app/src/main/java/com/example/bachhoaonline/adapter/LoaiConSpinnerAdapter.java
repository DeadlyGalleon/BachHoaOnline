...
public class LoaiConSpinnerAdapter extends ArrayAdapter<loaicon> {

    private Context context;
    private List<loaicon> loaiList;

    public LoaiConSpinnerAdapter(Context context, List<loaicon> loaiList) {
